...
<template>
  <div class="main-content-display" v-if="store.projects">
    <div class="introduction-section">
      <h2>We have {{ store.projects.length }} projects that {{getRandomCTA()}}</h2>
      <p>Data last updated on xx/xx/xxxx</p>
    </div>
    <div class="main-project-container">
      <ProjectCard v-for="item in store.projects" :project="item" />
    </div>
  </div>
</template>
